...
outputXMLPaths = {
	Author : "output.xml",
	Category : "output.xml",
	Slideshow : "output.xml",
	NavElement : "output.xml",
	Tag : "output.xml",
	Redirect : "output.xml",
	BlogPost : "blog_posts.xml",
	NewsPost : "news_posts.xml",
	Page : "pages.xml"
}
class MandatemediamigratorPipeline(object):
	# TODO: try breaking up into different files - say depending on item type, put posts and pages in separate files and everything else in one
	def process_item(self, item, spider):
		if type(item) is File:
			...
			for key in item.fields:
				item.setdefault(key,'')
				# TODO: this will need to access a dict specifying based on type what file to use
			with open(outputXMLPaths[type(item)],'a+') as f:
				f.write(item.format())
	...
	def open_spider(self, spider):
		...
		for _, path in outputXMLPaths.items():
